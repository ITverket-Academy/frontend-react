...
const OrderConfirmation = () => {
  ...
  const submitDiscount = (event: React.SyntheticEvent) => {
    // ⚒️ Stopp submit fra å oppdatere siden.
    // ⚒️ Sjekk om discount matcher ordet "billig". Hvis den gjør det, reduser shipping kostanden.
  };
      ...
      <div className="order-container-page">
        ...
        <div className="delivery-adress-container">
          ...
          <div className="order-invoice-adress">
            ...
            {/*
            💡 onSubmit kalles automatisk når man trykker "Enter".
            ⚒️ Legg til en onSubmit event i form elementet og kall på funksjonen submitDiscount 
            */}
            <form>
              <input
